...
const LJ_I18N = {
  ar: {
    ...
    about_desc: "مجموعة لمسة جمال التجارية تضم ثلاثة متاجر مستقلة تحت نظام واحد: لمسة جمال للمكياج والعناية بالبشرة، لمسة صبايا للإكسسوارات والموضة، ومعرض لمسة جمال للهدايا الفاخرة والأدوات المنزلية. نمنحك تجربة تسوق سلسة من التصفح إلى الطلب، وتواصل مباشر عبر واتساب مع فريق كل متجر.",
  ...
  en: {
    ...
    about_desc: "Lamset Jamal Group brings together three independent stores under one system: Lamset Jamal for makeup and skincare, Lamset Sabaya for accessories and fashion, and Maaraz Lamset Jamal for luxury gifts and home essentials. We give you a seamless shopping experience from browsing to ordering, with direct WhatsApp contact for each store's team.",
  ...
  he: {
    ...
    about_desc: "קבוצת למסת ג'מאל כוללת שלוש חנויות עצמאיות תחת מערכת אחת: למסת ג'מאל לאיפור וטיפוח עור, למסת סבאיא לאביזרים ואופנה, ומעראז' למסת ג'מאל למתנות יוקרה ולמוצרי בית. אנו מעניקים לך חוויית קנייה חלקה מהעיון ועד ההזמנה, עם קשר ישיר בוואטסאפ עם צוות כל חנות.",
